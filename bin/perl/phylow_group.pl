...
$usage .=   "Reads a transposed ogre table from STDIN, groups the entries according to IDFILE, and writes to STDOUT. ";
$usage .=   "IDFILE is a mapping table of KOs (col 0), OGs (col 1), tags (col 2), and groups (col 3, optional).\n";
$usage .=   "\n";
...
# loop through the input phyloways file
